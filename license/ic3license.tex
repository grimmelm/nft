...
\subsect{Ledgers and NFTs}
	...
	\item 	\iflicenseoption{\sharealike}{Adapted Material is ``Share-Alike Sublicensed'' from an NFT (the ``Parent NFT'') when the Parent NFT is Sublicensed by means of a Licensing Process that (1) creates another NFT (the ``Child NFT'') by means of the same NFT Generator that created the Parent NFT, (2) causes the Child NFT to be Linked to Adapted Material, and (3) causes the Child NFT to Invoke this license, provided that the Child NFT and Parent NFT have materially the same properties and functionality, except for the identity of the parties they are Associated with and the identity of the material they are Linked to.}
...
Subject to the terms and conditions of this License, and \iflicenseoption{\personal}{for as long as}\iflicenseoption{\conditional}{on the condition that} You are the Owner of the License NFT, the Licensor hereby grants to You a worldwide, royalty-free, sublicensable, non-exclusive, license to exercise the Licensed Rights to:
\begin{itemize}
...
\item \iflicenseoption{\sharealike}{Create and Use Adapted Material \iflicenseoption{\noncommercial}{for Non-Commercial purposes only}, provided that the Adapted Material is Share-Alike Sublicensed from the License NFT,}
...
This license grant is non-transferable. If the License NFT is Transferred such that You are no longer the Owner, Your rights under this license grant will terminate. Notwithstanding the previous sentence, You may continue to Use the Licensed Material and any already-existing Adapted Material under the terms of the license grant above for the duration of the Grace Period. You may not Create or Use new Adapted Material or grant new sublicenses during the Grace Period.
